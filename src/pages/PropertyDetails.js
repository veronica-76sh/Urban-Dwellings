...
const house = housesData.find((house) => {
  ...
  <div className="container mx-auto min-h-[800px] mb-14">
     <div className='flew flex-col lg:flex-row lg:items-center lg:justify-between'>
       <div>
       ...
       <div className='mb-4 lg:mb=0 flex gap-x-2 text-sm'>
        ...
        <div className='bg-violet-500 text-white px-3 rounded-full'>{house.country}
        </div>
       </div>
       <div className='text-3xl font-semibold text-violet-600'>$ {house.price}
       </div>
     </div>
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        <div className='max-w-[768px]'>
          <div className='mb-8'>
           ...
           <div className='flex gap-x-6 text violet-700 mb-6'>
              <div className='felx gap-x-2 items-center'>
        ...
        <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
          <div className='flex items-center gap-x-4 mb-8'>
              ...
              <div>
                <div className='font-bold text-lg'>{house.agent.name}</div>
                 <Link to='' className='text-violet-700 text-sm'>View Listings
                 </Link>
              </div>
          </div>
          {/* form */}
          <form className='flex flex-col gap-y-4'>
            ...
            defaultValue='Hello, I am in interested in [Modern apartment]'
            ></textarea>
